...
class InstanceDiscoverResponse(object):
    """
    ...
    def __init__(self, result=None):
        """
        InstanceDiscoverResponse - a model defined in Swagger
        """
    ...
    def result(self):
        """
        Gets the result of this InstanceDiscoverResponse.

        :return: The result of this InstanceDiscoverResponse.
        :rtype: list[str]
        """
        return self._result
    ...
    def result(self, result):
        """
        Sets the result of this InstanceDiscoverResponse.

        :param result: The result of this InstanceDiscoverResponse.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InstanceDiscoverResponse):
            return False
