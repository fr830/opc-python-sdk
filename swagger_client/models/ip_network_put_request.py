...
class IpNetworkPutRequest(object):
    """
    ...
    def __init__(self, description=None, ip_address_prefix=None, ip_network_exchange=None, name=None, tags=None):
        """
        IpNetworkPutRequest - a model defined in Swagger
        """
    ...
    def description(self):
        """
        Gets the description of this IpNetworkPutRequest.
        Description of the object.

        :return: The description of this IpNetworkPutRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this IpNetworkPutRequest.
        Description of the object.

        :param description: The description of this IpNetworkPutRequest.
        :type: str
        """
    ...
    def ip_address_prefix(self):
        """
        Gets the ip_address_prefix of this IpNetworkPutRequest.
        ...
        :return: The ip_address_prefix of this IpNetworkPutRequest.
        :rtype: str
        """
    ...
    def ip_address_prefix(self, ip_address_prefix):
        """
        Sets the ip_address_prefix of this IpNetworkPutRequest.
        Range of IPv4 addresses assigned in the virtual network, in CIDR address prefix format.<p>You can expand the network by specifying the same IP address prefix but with a shorter prefix length. For example, you can expand 192.168.1.0/24 to 192.168.1.0/20. Don't, however, change the IP address. This ensures that all IP addresses that have been currently allocated to instances remain valid in the updated IP network.

        :param ip_address_prefix: The ip_address_prefix of this IpNetworkPutRequest.
        :type: str
        """
    ...
    def ip_network_exchange(self):
        """
        Gets the ip_network_exchange of this IpNetworkPutRequest.
        ...
        :return: The ip_network_exchange of this IpNetworkPutRequest.
        :rtype: str
        """
    ...
    def ip_network_exchange(self, ip_network_exchange):
        """
        Sets the ip_network_exchange of this IpNetworkPutRequest.
        Specify the three-part name of the IP network exchange to which you want to add the IP network. You can add an IP network to only one IP network exchange, but an IP network exchange can include multiple IP networks. An IP network exchange enables access between IP networks that have non-overlapping addresses, so that instances on these networks can exchange packets with each other without NAT. 

        :param ip_network_exchange: The ip_network_exchange of this IpNetworkPutRequest.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this IpNetworkPutRequest.
        ...
        :return: The name of this IpNetworkPutRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this IpNetworkPutRequest.
        Specify the three-part name (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object</em></code>) of the IP network that you want to update. <p>Object names can contain only alphanumeric, underscore (_), dash (-), and period (.) characters. Object names are case-sensitive.

        :param name: The name of this IpNetworkPutRequest.
        :type: str
        """
        if name is None:
    ...
    def tags(self):
        """
        Gets the tags of this IpNetworkPutRequest.
        Tags associated with the object.

        :return: The tags of this IpNetworkPutRequest.
        :rtype: list[str]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this IpNetworkPutRequest.
        Tags associated with the object.

        :param tags: The tags of this IpNetworkPutRequest.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, IpNetworkPutRequest):
            return False
