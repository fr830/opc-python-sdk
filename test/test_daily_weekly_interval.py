...
class TestDailyWeeklyInterval(unittest.TestCase):
    """ DailyWeeklyInterval unit test stubs """
    ...
    def testDailyWeeklyInterval(self):
        """
        Test DailyWeeklyInterval
        """
        model = swagger_client.models.daily_weekly_interval.DailyWeeklyInterval()
