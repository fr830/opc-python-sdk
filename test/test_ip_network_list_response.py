...
from swagger_client.models.ip_network_list_response import IpNetworkListResponse


class TestIpNetworkListResponse(unittest.TestCase):
    """ IpNetworkListResponse unit test stubs """
    ...
    def testIpNetworkListResponse(self):
        """
        Test IpNetworkListResponse
        """
        model = swagger_client.models.ip_network_list_response.IpNetworkListResponse()
