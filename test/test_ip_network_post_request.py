...
from swagger_client.models.ip_network_post_request import IpNetworkPostRequest


class TestIpNetworkPostRequest(unittest.TestCase):
    """ IpNetworkPostRequest unit test stubs """
    ...
    def testIpNetworkPostRequest(self):
        """
        Test IpNetworkPostRequest
        """
        model = swagger_client.models.ip_network_post_request.IpNetworkPostRequest()
