...
from swagger_client.models.ip_network_put_request import IpNetworkPutRequest


class TestIpNetworkPutRequest(unittest.TestCase):
    """ IpNetworkPutRequest unit test stubs """
    ...
    def testIpNetworkPutRequest(self):
        """
        Test IpNetworkPutRequest
        """
        model = swagger_client.models.ip_network_put_request.IpNetworkPutRequest()
