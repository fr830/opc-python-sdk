...
from swagger_client.models.ip_network_response import IpNetworkResponse


class TestIpNetworkResponse(unittest.TestCase):
    """ IpNetworkResponse unit test stubs """
    ...
    def testIpNetworkResponse(self):
        """
        Test IpNetworkResponse
        """
        model = swagger_client.models.ip_network_response.IpNetworkResponse()
